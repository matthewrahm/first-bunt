      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gold-200 max-w-2xl mx-auto">
            Get your hands on {tokenSymbol} tokens. Copy the contract address below to add to your wallet.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          >
            <div className="text-center">
              <div className="w-20 h-20 bg-gradient-to-br from-gold-300 to-gold-500 rounded-full flex items-center justify-center mx-auto mb-6">
                <span className="text-3xl font-bold text-ink-900">{tokenSymbol[0]}</span>
              </div>
              <h3 className="text-2xl font-bold text-white mb-2">{tokenName}</h3>
              <p className="text-gold-200 text-lg mb-4">Symbol: {tokenSymbol}</p>
          ...
          >
            <h3 className="text-xl font-bold text-white mb-6 text-center">Contract Address</h3>
        ...
        >
          <div className="bg-ink-800/50 border border-ink-700 rounded-xl p-8">
            <h3 className="text-2xl font-bold text-white mb-4">How to Add {tokenSymbol}</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-300">Copy the contract address above</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-300">Import custom token in your wallet</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-300">Buy and sell on supported DEXs</p>
              </div>
            </div>
          </div>
        </motion.div>
